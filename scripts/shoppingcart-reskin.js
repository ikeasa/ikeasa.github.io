(function () {
  ...
  //shopping list AR
  if ((PrevURL === 'https://securem.ar.ikea.com/sa/ar/login/') && (window.location.href.indexOf("/sa/ar/shoppinglist/") > -1)) {
      window.location.href = "https://securema.ikea.com/ksawebapp/profile";
  }
  //shopping list EN
  if ((PrevURL === 'https://securem.ikea.com/sa/en/login/') && (window.location.href.indexOf("/sa/en/shoppinglist/") > -1)) {
      window.location.href = "https://securema.ikea.com/ksawebapp/profile";
  }
...
(function() {
  ...
  function modifyHeaderFooter() {
      ...
      var headerContent =
          ...
          '<a href="' + baseURL + '" class="head__logo"><img class="svg-icon" src="https://www.ikea.com/sa/en/static/ikea-logo.f88b07ceb5a8c356b7a0fdcc9a563d63.svg" alt="IKEA" title="IKEA"><span class="header__sr-only">IKEA</span></a>' +
          ...
          '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="https://order.ikea.com/sa/en/checkout/shoppinglist"><div class="header__icon-list-item-icon">' +
          ...
          '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="https://secure.ikea.com/sa/en/mcommerce/shoppingcart"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-SA">' +
