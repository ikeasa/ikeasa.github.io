(function() {
    ...
    function __(english) {
      const arabic = {
        ...
        'https://secure.ikea.com/bh/en/mcommerce/shoppingcart': 'https://secure.ar.ikea.com/bh/ar/mcommerce/shoppingcart'
      };
    ...
    function modifyHeaderFooter() {
        ...
        '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="' + __('https://secure.ikea.com/bh/en/mcommerce/shoppingcart') + '"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-BH">' +
