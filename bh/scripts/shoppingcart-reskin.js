(function () {
  ...
  window.location.replace(
    "https://securema.ikea.com/bh/" + lang + "/shoppingbag"
  );

  var newCheckoutLink =
    "https://securema.ikea.com/" + market + "/" + lang + "/checkout/";
  if (
...
(function () {
  ...
  function __(english) {
    const arabic = {
      ...
      "https://www.ikea.com/bh/en/profile/#/login":
        "https://ar.ikea.com/bh/ar/profile/#/login",
      "https://secure.ikea.com/bh/en/mcommerce/shoppingcart":
        "https://secure.ar.ikea.com/bh/ar/mcommerce/shoppingcart",
    };
  ...
  function modifyHeaderFooter() {
    ...
    const headerContent =
      ...
      '<a href="' +
      baseURL +
      '" class="head__logo"><img class="svg-icon" src="https://www.ikea.com/bh/en/static/ikea-logo.f88b07ceb5a8c356b7a0fdcc9a563d63.svg" alt="IKEA" title="IKEA"><span class="header__sr-only">IKEA</span></a>' +
      '<nav class="header__navigation" role="navigation"><ul class="desktop-menu">' +
      '<li class="desktop-menu__item"><a href="' +
      baseURL +
      'cat/products-products/" class="desktop-menu__link"><span class="desktop-menu__title">' +
      __("Products") +
      "</span></a></li>" +
      '<li class="desktop-menu__item"><a href="' +
      baseURL +
      ...
      __("https://www.ikea.com/bh/en/profile/#/login") +
      ...
      __("My profile") +
      "</span></a></li>" +
      '<li class="header__icon-list-item"><a class="header__icon-list-item-link" href="https://order.ikea.com/bh/' +
      lang +
      ...
      __("Shopping list") +
      "</span></a></li>" +
      '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="' +
      __("https://secure.ikea.com/bh/en/mcommerce/shoppingcart") +
      '"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-BH">' +
