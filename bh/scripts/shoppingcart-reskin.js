(function() {
    ...
    function modifyHeaderFooter() {
        ...
        '<li class="header__icon-list-item"><a class="header__shopping-cart header__icon-list-item-link" href="https://secure.ikea.com/bh/en/mcommerce/shoppingcart"><div class="header__icon-list-item-icon js-shopping-cart-icon" data-market-code="en-BH">' +
